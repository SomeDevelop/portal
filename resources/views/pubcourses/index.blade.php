                        ...
                        <div class="col-lg-12">
                            <header class="codrops-header">
                                ...
                                <nav class="codrops-demos">
                                    <a href="{{route('publiccourses')}}">All <span class="course-count pull-right"> ({{$courses->count()}})</span></a>
                                    @forelse ($categories as $category)

                                        <a href="{{route('category.slug', $category->slug)}}">{{$category->title}}<span
                                                    class="course-count pull-right"> ({{$category->courses()->count()}}
                                                )</span></a>

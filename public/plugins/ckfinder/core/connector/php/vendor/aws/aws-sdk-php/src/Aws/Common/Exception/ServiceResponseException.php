...
class ServiceResponseException extends RuntimeException
{
     ...
     * error.
     *
     * Same as `getRequestId()` method, but matches the intercat for SDKv3.
     *
     ...
     *
     * Same as `getExceptionType()` method, but matches the intercat for SDKv3.
     *
     * @return string|null Returns null if no response was received
     */
     ...
     *
     * Same as `getExceptionCode()` method, but matches the intercat for SDKv3.
     *
     * @return string|null Returns null if no response was received
     */

...
class DebugClassLoader
{
    ...
    /**
     * Loads the given class or intercat.
     *
                ...
                if (!$parent || strncmp($ns, $parent, $len)) {
                    ...
                    foreach ($deprecatedInterfaces as $interface) {
                        if (!isset($parentInterfaces[$interface])) {
                            @trigger_error(sprintf('The %s %s %s that is deprecated %s', $name, $refl->isInterface() ? 'intercat extends' : 'class implements', $interface, self::$deprecated[$interface]), E_USER_DEPRECATED);
                        }
                    }
                }
            }
